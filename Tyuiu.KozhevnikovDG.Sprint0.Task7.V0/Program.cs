...
using Tyuiu.KozhevnikovDG.Sprint0.Task7.V0.Lib;

namespace Tyuiu.KozhevnikovDG.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Кожевников Д. Г. | ИИПБ-23-1";
            Console.WriteLine("***************************************************************************");
            ...
            if (arrayNums1.Length == arrayNums2.Length)
            {
                ...
                Console.WriteLine("Сумма элеметов массива ровна:");
